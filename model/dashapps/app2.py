...
df1 =pd.read_csv('data/fre_unigrams_pro.csv')
df2 =pd.read_csv('data/fre_bigram_pro.csv')
df3=pd.read_csv('data/fre_trigrams_pro.csv')
app2=DjangoDash('Promoteur', external_stylesheets=external_stylesheets)
app2.css.append_css({ "external_url" : "/static/model/css/s2.css" })
app2.layout = html.Div([
    html.H3('Promoteurs',style={'textAlign': 'center'}),
